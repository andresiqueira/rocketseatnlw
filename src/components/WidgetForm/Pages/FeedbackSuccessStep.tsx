...
interface IhandleRestartFeedback {
  handleRestartFeedback: () => void
}

export const FeedbackSuccessStep = ({ handleRestartFeedback }: IhandleRestartFeedback) => {
  return (
    <>
      <header>
        <Popover.Button>
      ...
      <div className='flex flex-col items-center py-10 w-[19rem]'>
        ...
        <button className='bg-[#8257E5] p-2 w-full rounded' onClick={handleRestartFeedback}>
          Quero enviar outro
        </button>
      </div>
    </>
